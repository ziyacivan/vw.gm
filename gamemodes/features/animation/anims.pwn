ApplyAnimationEx(playerid, const animlib[], const animname[], Float:Speed, looping, lockx, locky, lockz, lp)
{
	//if(GetPlayerState(playerid) != PLAYER_STATE_ONFOOT) return ServerMessage(playerid, "Bu animasyonu sadece yayayken kullanabilirsin.");
